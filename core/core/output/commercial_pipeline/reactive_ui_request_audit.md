# Polyrust V3 商业审计报告 — reactive_ui_request

**版本**: v3.0-commercial | **时间**: 1789810036 | **迭代**: 3

**判定**: SAT ✅ | **风险**: 15.5 (low) | **ISO**: QM (Quality Management)
...
|---|---|---|---|---|---|---|---|
| 1 | SAT | 166 | 100 | f4f5 | 9.5 | 133 |  |
| 2 | SAT | 208 | 124 | f4f5 | 11.5 | 219 |  |
| 3 | SAT | 208 | 124 | f4f5 | 13.5 | 184 | ✓ |
