# Polyrust V3 商业审计报告 — missing_syntax

**版本**: v3.0-commercial | **时间**: 1789861459 | **迭代**: 3

**判定**: SAT ✅ | **风险**: 12.0 (low) | **ISO**: QM (Quality Management)
...
|---|---|---|---|---|---|---|---|
| 1 | SAT | 76 | 58 | classic | 6.0 | 51 |  |
| 2 | SAT | 140 | 112 | f4f5 | 8.0 | 108 |  |
| 3 | SAT | 140 | 112 | f4f5 | 10.0 | 90 | ✓ |
