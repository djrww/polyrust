...
/// 實際使用：groebner.rs 文件清單 — 優化 with_capacity
pub fn groebner_file_list() -> Vec<(&'static str, &'static str, &'static str)> {
    vec![
        ("groebner.rs", "groebner.rs 正式運作 — 優化 with_capacity", "core/src/groebner.rs"),
    ]
}
